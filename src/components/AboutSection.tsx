...
const AboutSection = () => {
  return (
    <section id="about" className="section-padding bg-white dark:bg-neutral relative">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <Card className="p-6 md:p-8 border border-lavender bg-white/80 backdrop-blur-sm dark:bg-neutral/50 rounded-xl">
              ...
              <div className="mt-8 border-t border-lavender pt-6">
                <h4 className="font-semibold text-lg text-neutral dark:text-white mb-3">
                  Fun Facts
                </h4>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-indigo dark:text-lavender mr-2">•</span>
                    <p className="text-textgray dark:text-white/80">I've visited 23 countries to capture stories around the world</p>
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo dark:text-lavender mr-2">•</span>
                    <p className="text-textgray dark:text-white/80">My content has reached over 20 million views across platforms</p>
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo dark:text-lavender mr-2">•</span>
                    <p className="text-textgray dark:text-white/80">I once filmed a documentary while surviving on a deserted island for a week</p>
                  </li>
                </ul>
              </div>
            </Card>
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-xl overflow-hidden shadow-2xl border-4 border-white dark:border-neutral z-10 relative">
                <img 
              ...
              <div className="absolute -bottom-4 -right-4 w-64 h-64 md:w-80 md:h-80 bg-lavender rounded-xl -z-10"></div>
            </div>
          </div>
        </div>
      </div>
