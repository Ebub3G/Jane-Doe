...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="section-padding bg-white dark:bg-navy/95">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="services-card border border-lavender/30 dark:border-transparent bg-white dark:bg-navy/50">
              <CardContent className="p-6 md:p-8 flex flex-col items-center text-center md:text-left md:flex-row md:items-start">
                <div className="mb-4 md:mb-0 md:mr-6 bg-lavender/20 dark:bg-lavender/10 p-4 rounded-full">
                  <service.icon className="w-8 h-8 text-navy dark:text-lavender" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-navy dark:text-white mb-2">{service.title}</h3>
